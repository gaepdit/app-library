...
{
    /// <summary>
    /// Returns a boolean indicating whether an <see cref="TEntity"/> with the given <paramref name="id"/> exists.
    /// </summary>
    ...
    /// <summary>
    /// Returns a boolean indicating whether an <see cref="TEntity"/> exists matching the conditions of
