    ...
    where TUserKey : IEquatable<TUserKey>
{
    ...
    /// <summary>
    /// Sets the <see cref="CreatedById"/> property to the <paramref name="userId"/> parameter value and sets
    ...
    /// <summary>
    /// Sets the <see cref="UpdatedById"/> property to the <paramref cref="userId"/> parameter value and sets
